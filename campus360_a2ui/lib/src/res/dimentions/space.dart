...
class Space {
  ...
  static void init() {
    ...
    // Removed UI dependency as it's not ported, assuming safe area handling elsewhere
    top = SizedBox(height: 0);
    bottom = SizedBox(height: 0);
  }
  ...
  static EdgeInsets hf([double no = 1]) =>
      EdgeInsets.symmetric(horizontal: AppDimensions.space(no));
  static EdgeInsets vf([double no = 1]) =>
